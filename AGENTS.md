...
10. **Truth precedence** — when live docs conflict without implementation evidence, highest wins:
    ...
    A material contradiction between `reference/` and source/tests/Git is **not**
    auto-resolved by this order — determine regression vs stale reference vs
    ambiguity per `docs/README.md` §Progressive project knowledge.
