...
[`../hand-off/CURRENT.md`](../hand-off/CURRENT.md).
...
surface — see [`../design/P23.14-shell-design-context.md`](../design/P23.14-shell-design-context.md)
...
owes reasoned refusals for unsupported/unresolved floors (`docs/plans/2026-09-10-P24-minimum-child-plans.md`),
...
- [`../north-star.md`](../north-star.md) — world-local placement target.
- [`../components/camera-tour.md`](../components/camera-tour.md) — Camera Plan contract
  ("Add Camera needs a room-floor hit" is the premise this defect invalidates).
- [`../components/placement.md`](../components/placement.md) — placement/grounding.
