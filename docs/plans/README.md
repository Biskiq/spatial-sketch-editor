...
| P23 | Layout Depth — minimum useful Build set | approved — owner-ratified wall-first reconciliation 2026-09-09; H1/H2/H3/H5 complete; coupled Foundation Gate **P23.0a → P23.8 → P23.0b shipped** (commits `13a96a0`, `7d9df94`, `41a5cde` on main); **F0 CLOSED 2026-09-10** — stage-6 writer flip `455f587`, cross-format transaction-invariant fix `93111a2`, candidate-proof tightening `79b3551`, merged through PR #7 as `32b2e8f`; wall-first writes are adapted; **P23.1 merged through PR #9 as `d5ec0df`; P23.2 merged through PR #13 as `a369a15`; P23.9 merged through PR #18 as `5f20aaa`; P23.3 merged through PR #19 as `d1705b7`; P23.4 merged through PR #21 as `c6601f2`; P23.5 merged through PR #22 as `75a32ca`**; P23.6 merged through PR #23 as `3f6c78d`; [P23.6H](2026-09-12-P23.6H-vertical-wall-semantics.md) (authoritative per-Wall height) and [P23.6I](2026-09-12-P23.6I-wall-defined-vertical-envelope.md) — Wall-defined vertical envelope: retires canonical `floor.height`, unbounded per-Wall heights, Wall-derived flat Room ceilings, **`5` as the only recognized wall-first version** (the pre-baseline decision refuses a `4` payload by name instead of migrating it) — are **merged through PR #25 as `746aa16`**; [P23.6a](2026-09-12-P23.6a-wall-first-room-unit-move.md) is **`implemented` on branch `P23.6a`** — a rigid Room-unit move on the one selection/reconciliation/history authority, where **amendment A** makes the movable unit the *connected Room group* (drag any member, the whole unit travels; shared interior Walls move once) so single-Room isolation no longer blocks a contiguous layout — and **Layout Room multi-select is registered as a deferral (Issue #28)**: [P23.6b](2026-09-12-P23.6b-architecture-hierarchy-inspector-reconciliation.md) is **`implemented` on branch `P23.6b`** (ownership-truthful hierarchy + canonical-only Inspector, `precisionTarget` retired) + [P23.6c](2026-09-13-P23.6c-canonical-wall-deletion.md) is **`implemented` on branch `p23.6c`** (canonical Wall deletion through the one `planDeleteWall`/`deleteWallFirstWall` planner — viewport Delete/Backspace, Inspector Wall panel and hierarchy wall-row context menu share it; PR #25 review follow-up with endpoint-scoped Junction cleanup and row-authority-gated context menu) + [P23.6d](2026-09-13-P23.6d-canonical-room-lifecycle-completion.md) is **`implementation-ready`** (canonical Room lifecycle completion — `planRoomMetadataUpdate` + guard-railed `planRemoveRoom` over the P23.8 engine; Room removal is never a record splice) + [P23.6e](P23.6e-directive.md) (final Hierarchy/product-semantics UI overhaul, formerly labeled 6d) stays future implementation; order is P23.6 → P23.6H → P23.6I → P23.6a → P23.6b → P23.6c → P23.6d → P23.6e → P23.7 (dependency-driven, not numeric), where **H + I landed as the single format-5 vertical cutover (I adds no schema generation)** | P22 | [umbrella](2026-09-07-P23-layout-depth-minimum-build.md) |
| P23.6d | Canonical Room Lifecycle Completion | implementation-ready — canonical Room metadata/name editing (`planRoomMetadataUpdate`) + guard-railed `planRemoveRoom` (one exclusive boundary Wall through the P23.6c pipeline; P23.8 reconciliation retires the Room; never a record splice); planning only, not implemented | [P23.6c](2026-09-13-P23.6c-canonical-wall-deletion.md) | [2026-09-13-P23.6d-canonical-room-lifecycle-completion.md](2026-09-13-P23.6d-canonical-room-lifecycle-completion.md) |
...
- Next: P23.1 merged through PR #9 as `d5ec0df`; P23.2 merged through PR #13 as `a369a15`; P23.9 merged through PR #18 as `5f20aaa`; P23.3 merged through PR #19 as `d1705b7`; P23.4 merged through PR #21 as `c6601f2`; P23.5 merged through PR #22 as `75a32ca`; P23.6 merged through PR #23 as `3f6c78d`; P23.6H and P23.6I are **merged through PR #25 as `746aa16`** — H + I landed as the single format-5 vertical cutover, and `5` is the only recognized wall-first version. P23.6a is **`implemented` on branch `P23.6a`** (see its §Implementation record); **P23.6b is `implemented` on branch `P23.6b`** (see its §Implementation record); **P23.6c is `implemented` on branch `p23.6c`** (see its §Implementation record); **[P23.6d](2026-09-13-P23.6d-canonical-room-lifecycle-completion.md) is `implementation-ready`** (canonical Room lifecycle completion — planning only); **[P23.6e](P23.6e-directive.md)** (final Hierarchy/UI overhaul, formerly labeled P23.6d) is future implementation — current focus is **P23.6d implementation, then P23.6e, then P23.7 closeout**. P24 R0–R9 planning complete: [minimum freeze](2026-09-10-P24-R9-minimum-freeze.md) and [child briefs](2026-09-10-P24-minimum-child-plans.md) await owner review; execution still waits for accepted P23 minimum. All P24 implementation/parity gates remain open. Prior: P22 shipped 2026-09-08 (P22.1–P22.5 + hosted acceptance — production
