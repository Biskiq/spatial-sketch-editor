...
Rejoin into a **later** Sequence stop (`B → X → Y → C` with C after B) is a recognized future extension, not yet modeled — see the [branch-rejoin experiment brief](../../roadmap/backlog/2026-08-21-branch-rejoin-experiment.md) (unscheduled).
