...
Paper is warm and visually distinct from application chrome.
...
**a warm spatial Paper held inside a cool engineered Chassis, with compact Instruments attached directly to the work; Scene/Camera running vertically, Plan/3D running horizontally, and one coherent identity moving through Navigator, viewport, Inspector and Timeline.**
