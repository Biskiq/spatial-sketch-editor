...
- `docs/archive/roadmap/p23/foundation-research/P23-H1-wall-room-geometry.md`
- `docs/archive/roadmap/p23/foundation-research/P23-H2-snapping-selection-guides.md`
- `docs/archive/roadmap/p23/foundation-research/P23-H3-robust-geometry.md`
- `docs/archive/roadmap/p23/foundation-research/P23-H5-room-identity-migration.md`
- `docs/archive/roadmap/p23/foundation-research/P23-wall-first-replan-proposal.md` — staging decision record only; superseded as planning authority by this reconciled umbrella.
