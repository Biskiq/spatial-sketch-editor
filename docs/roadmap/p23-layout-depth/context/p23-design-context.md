...
**Authority order used here:** source code + tests → `docs/operations/current.md` →
active plan → component contract → `docs/reference/architecture.md` → `docs/reference/north-star.md`
(`AGENTS.md` §10).
...
(`docs/reference/north-star.md`). **[C]**
...
- **Left rail width** is the shell's left sidebar track:
  ...
  ~2191; `tokens.css`; §15 of `docs/reference/design-system/design-specs.md` documents
  "Left sidebar 300px / minimum 240px".)
  **Mismatch to know:** the P23.6e directive calls this the "canonical **268 px**
  Navigator rail" (`docs/roadmap/p23-layout-depth/P23.6e-directive.md:141`), and the P23 roadmap said the
...
> **Roadmap/tracker mismatch:** `docs/roadmap/p23-layout-depth/README.md:136,193` and
> `docs/operations/current.md` still say "P23.11 is next" / "review and merge
...
The roadmap (`docs/roadmap/p23-layout-depth/2026-09-14-P23-remaining-roadmap-reconciliation.md`)
...
2. **The compact-reference mechanism is not chosen yet.** The roadmap requires
   ...
   **not** exist in code today (`docs/roadmap/p23-layout-depth/2026-09-13-P23.6e-…md` Gate 1
...
| Product direction / phases | `docs/reference/north-star.md` |
| Ownership table | `docs/reference/architecture.md` |
| Visual system | `docs/reference/design-system/design-specs.md` (§7 colors, §9 plan, §15 shell, §28A/§29 selection, §35 status); `docs/reference/design-system/shell-scene-workspaces.md` §6 |
| Remaining P23 scope | `docs/roadmap/p23-layout-depth/2026-09-14-P23-remaining-roadmap-reconciliation.md` |

## Appendix B — roadmap vs code mismatches to carry forward

| # | Document says | Code says | Effect on design work |
|---|---|---|---|
| 1 | `docs/roadmap/p23-layout-depth/README.md:136,193` and `docs/operations/current.md` — P23.11 is next; PR #50 awaiting review | P23.11 merged on `main` (PR #51, `9118696`, 2026-09-15); `LayoutWall.centerline` + curve UX shipped | Treat curve editing as **shipped**; P23.12–P23.16 as remaining |
