...
**Readiness update (2026-09-24):** P24 remains proposed and inherits the unified spatial system delivered by P26 after P23B. R9 remains inclusion/maturity/operation/acceptance authority; its earlier implementation-ready designation is conditional on focused reconciliation with landed P26. P23 is closed. The [P26 handoff](../p26-spatial-depth/2026-09-24-P26-continuous-spatial-authoring-umbrella.md#11-p24-handoff) identifies affected R3/R4/R8/R9 and child-plan assumptions: separate PlanProxy/3D surfaces, placement/picking, view-switch gestures, multi-selection/gizmos, overlays/Inspector, Camera preview and shell exposure. Asset supply/ingest and Scene ownership remain in scope. No comprehensive P24 rewrite or implementation authorization occurs here. Earlier draft/pending-minimum statements below remain superseded by R9; this update adds the landed-P26 reconciliation gate.


**Ratified cross-view direction:** [Unified Plan / 3D authoring addendum](../p23-layout-depth/2026-09-09-P23-P24-unified-plan-3d-authoring-addendum.md) — read alongside this plan for entity-owned mutations, selection continuity, gesture cancellation and PlanProxy/placement ownership. Entity-owned mutations and placement direction remain; separate-surface implementation assumptions now await P26 reconciliation.

**Created:** 2026-09-08 · **Status:** proposed (tracker authoritative)
**Depends on:** P23 closed → P23B → P26 unified spatial foundation; P24 reconciliation and approval.
**Detail status:** R0–R9 planning reconciliation complete; minimum frozen; child briefs require landed-P26 reconciliation before owner implementation review. Implementation and acceptance remain open.
...
- `docs/roadmap/p24-scene-staging/research/deep-research-exact-asset-compact.md`
- `docs/roadmap/p24-scene-staging/research/museum-editor-phase2-acquisition-manifest.json`
...
`docs/roadmap/p24-scene-staging/research/deep-research-P24-3D-editing.md`.
...
The [Three r175–r186 harvest](./research/three-r175-r186-museum-harvest.md) is complete as a source audit. It identifies
