...
Verification and prototype limits are recorded in [review-notes.md](./review-notes.md), which also carries the focused screenshot-based visual acceptance pass and the four owner rulings of 2026-09-23: independent Layout-owned ceiling regions affirmed, independently authored opening arch rise approved, the twelve-room finite-depth semantics confirmed, and several fixtures in one project closed as a non-decision. Those rulings dispose of specific decision items; they do **not** ratify this proposal, select it over another submission, approve its whole interaction model, or authorize implementation. Two related questions — the ceiling datum under a floor change, and convenient enclosed-room wall/ceiling fitting — are carried forward to the final A/B/REGISTER synthesis rather than settled here.
